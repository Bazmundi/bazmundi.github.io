...
[Ordered](https://www.aliexpress.com/item/32993041509.html?spm=a2g0s.9042311.0.0.43ae4c4dm7XEea) a [XGecu TL866II Plus USB Universal Programmer](http://www.xgecu.com/en/TL866_main.html) with 16 adapters.



Good for programming [15000+ parts](http://www.xgecu.com/MiniPro/TL866II_List.txt).
...
So, yes. I can now program PLD/GAL that are defined by [CUPL](https://organicmonkeymotion.wordpress.com/2020/09/21/what-fun/), with outputs in [HEX](https://en.wikipedia.org/wiki/Intel_HEX) but not [JEDEC](https://en.wikipedia.org/wiki/JEDEC_memory_standards#:~:text=The%20JEDEC%20memory%20standards%20are,JEDEC%20Standard%20100B.).



Warning! There was mention on a video unpacking on Youtube of problem with clones of the [XGecu TL866II Plus](http://www.xgecu.com/en/TL866_main.html). The software for the programmer is only on the XGecu site and the warning is that clones may not work with the genuine software.
...
I almost bought one from that ebay shop but I hesitated and I was glad I did. I checked the XGecu site and the ebay site did not appear to be listed as a genuine retailer. In fact, you'll note the link above is to the [Aliexpress store of XGecu](https://xgecu.aliexpress.com/store/4805043?spm=a2g0o.detail.100005.1.3fbf4e0blAB0GW) as pointed to by the [XGecu site](http://www.xgecu.com/en/TL866_Dealer.html). There is a photo on that XGecu page with both green and black 40pin sockets (or at least as per the pictures). So is a black or a green 40pin socket indication of a "read" unit or is it that you may get a black one or a green one?



Fun fact, the genuine XGecu store on Aliexpress seems to have the best prices as well. Not to mention, while the videographer bought from an ebay store, he did not buy from the [XGecu ebay store](https://www.ebay.com/str/xgecuofficialstore). DOH! Of course, he could also have bought from the [official XGecu Amazon store](https://www.amazon.com/xgecu). Double DOH!

...
The rants in the Raspingdoodleberry Pi community [about ODROID cheating](https://www.raspberrypi.org/forums/viewtopic.php?f=62&t=83148), even though RPi comes under Creative Commons were interesting.
...
The notion of opensource hardware appears, in fact, to be [PCB level and not schematic level](https://www.youtube.com/watch?v=QXLShQH__6M). So, without specific restrictions in place, building a PCB from the supplied schematic is a remix, in tune with the CC offered by the rasping lot.
...
The more interesting thing is, apart from potty talk from the Raspingdoodlebury community, there appeared no other action directly on their part. The action on behalf of the Raspingdoodlebury Pi [was apparently taken by Broadcom](https://www.theinquirer.net/inquirer/news/2362800/hardkernel-cancels-raspberry-pi-like-odroid-w-after-broadcom-stops-supplying-soc) (according to some viewpoints).



Its hard to unpick the [Broadcom/Raspberry Pi think](https://en.wikipedia.org/wiki/Eben_Upton).
